...
# Clonar el repositorio: Solo se abre la terminal y se escribe el siguiente comando: git clone https://github.com/Andrey-Red2004/Repositorio-investigaci-n-Demo.git
# el unico requisito es tener un navegador o bien se puede usar live server de VSC para ver los cambios en tiempo real.
# Para navegar directo hasta la carpeta solo se inserta el siguiente comando: cd [nombre de la carpeta]
